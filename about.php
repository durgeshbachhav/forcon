                    ...
                    <ul class="header_nav-list">
                        <!--li class="header_nav-list_item dropdown">
                         ...
                         <li class="header_nav-list_item">
                            <a class="nav-item nav-link" href="index.html" data-page="about" data-single="true">
                                <span class="nav-item_text">Home</span>
                            </a>
                        </li>
                        <li class="header_nav-list_item">
                        ...
                        <li class="header_nav-list_item">
                            <a class="nav-item nav-link" href="projects.html" data-page="about" data-single="true">
                                <span class="nav-item_text">Projects</span>
                            </a>
                        </li>
                        <li class="header_nav-list_item">
                            <a class="nav-item nav-link" href="plant&machinery.html" data-page="about" data-single="true">
                                <span class="nav-item_text">Plant & Machinery</span>
                            </a>
                        </li>
                        <li class="header_nav-list_item">
                            <a class="nav-item nav-link" href="contact.html" data-page="about" data-single="true">
        ...
        <main>
            <section class="about section">
                <div class="container">
                    ...
                    <div class="media" data-aos="zoom-in" data-aos-duration="700">
                        <picture>
                            <source data-srcset="img/about1.jpg" srcset="img/about1.jpg" type="image/webp" />
                            <img class="lazy" data-src="img/about1.jpg" src="img/about1.jpg" alt="About Us" />
                        </picture>
                    </div>
                </div>
            ...
            <!--section class="quote section"><div class="container">
                <div class="services_header section_header">
                        ...
                        <!--h2 class="title">Our <span class="highlight">Timeline:</span></h2>
                    </div>
                <div class="media"><img src="img/Timeline.jpg"></div></div></section-->
                ...
                <div class="container">
                    ...
                    <div class="main">
                     <div class="quote_header section_header">
                        <p>In addition to these accomplishments, we successfully completed the First Police housing project in Dhule in 2018, a testament to our commitment to quality and customer satisfaction. Our endless efforts were recognized with an award for excellent contribution to the development of infrastructure for NHAI Project.</p><br>
                        <p>Our company's name, Forcon, represents our commitment to hard work, stability, and a strong forward thrust. By providing robust and dependable infrastructure solutions, we believe we can contribute to the development of a more promising future for our clients and the communities we serve.</p>
                     </div>
                    </div>
            ...
            <section class="services section">
                <div class="container">
                    <div class="services_header section_header">
                        <!--span class="subtitle">Just feel the future</span-->
                        <h2 class="title">Our <span class="highlight">Core Competency:</span></h2>
                    </div>
                    <div class="img-wrp"> <img src="img/Info1.jpg"></div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="services_slider-slide swiper-slide">
                                    <div class="media">
                                        <picture>
                                            <source data-srcset="img/placeholder.jpg" srcset="img/placeholder.jpg" type="image/webp" />
                                            <img class="lazy" data-src="img/placeholder.jpg" src="img/placeholder.jpg" alt="Process Engineering" />
                                        </picture>
                                    </div>
                                    <div class="main">
                                        ...
                                        <ul class="list">
                                            ...
                                            <li class="checklist_item"><i class="icon-arrow_right icon"></i> Innovation and creativity</li>
                                        </ul>
                                ...
                                <div class="services_slider-slide swiper-slide">
                                    <div class="media">
                                        <picture>
                                            <source data-srcset="img/placeholder.jpg" srcset="img/placeholder.jpg" type="image/webp" />
                                            <img class="lazy" data-src="img/placeholder.jpg" src="img/placeholder.jpg" alt="Specialty Services" />
                                        </picture>
                                    </div>
                                    <div class="main">
                                ...
                                <div class="services_slider-slide swiper-slide">
                                    <div class="media">
                                        <picture>
                                            <source data-srcset="img/placeholder.jpg" srcset="img/placeholder.jpg" type="image/webp" />
                                            <img class="lazy" data-src="img/placeholder.jpg" src="img/placeholder.jpg" alt="Civil engineering" />
                                        </picture>
                                    </div>
                                    <div class="main">
                ...
                <div class="container">
                    <div class="features_content">
                        ...
                        <div class="features_card features_card--alt" data-aos="fade-up">
                            <div class="wrapper">
                                ...
                                <h4 class="features_card-title">Vision:</h4>
                                <p class="features_card-description">
                                    At Forcon Infra, we recognize the significant societal impact of infrastructure and are committed to playing a crucial role in the advancement of national infrastructure facilities for economic and cultural integration. Our aim is to establish long-lasting customer partnerships based on trust, honesty, and transparency. Our ultimate objective is to be the nation's leading provider of infrastructure solutions.
                                </p>
                            </div>
                        </div>
                        <div class="features_card features_card--alt" data-aos="fade-up" data-aos-delay="50">
                            <div class="wrapper">
                                ...
                                <h4 class="features_card-title">Mission:</h4>
                                <ul class="features_card-description" style="list-style:disc">
                                <li>Provide the best products and services</li>
                                <li>Ensure affordability without compromising quality</li>
                                <li>Meet project deadlines and adhere to quality standards</li>
                                <li>Utilize methodical planning, execution, management, and monitoring processes</li>
                                <li>Commitment to delivering the best possible results</li>
                                <li>Never compromise on the quality of deliverables</li>
                                </ul>
                                <!--p class="features_card-description">
                                    We aspire to provide the best products and services at the most affordable price while meeting all deadlines and quality standards in order to accomplish the project's objectives and significance in the most convenient and stress-free manner. The application of methodical planning, execution, management, and monitoring processes by the company's customer-facing teams enable them to achieve the best possible results. Under no circumstances do we ever compromise on the quality of our deliverables. Since we are assisting in the development of the nation's infrastructure, we assume responsibility for the deliverables to continue serving many more future generations.
                                </p-->
                            </div>
                        </div>
                        <div class="features_card features_card--alt" data-aos="fade-up">
                            <div class="wrapper">
                                ...
                                <h4 class="features_card-title">Director's Message:</h4>
                                <p class="features_card-description">
                                    At Forcon Infra, we recognize the significant societal impact of infrastructure and are committed to playing a crucial role in the advancement of national infrastructure facilities for economic and cultural integration. Our aim is to establish long-lasting customer partnerships based on trust, honesty, and transparency. Our ultimate objective is to be the nation's leading provider of infrastructure solutions.
                                </p>
                            </div>
                    ...
                    <!--div class="video" data-aos="zoom-in" data-aos-duration="600">
                        <div class="video_cover">
                            <picture>
                                <source data-srcset="img/placeholder.jpg" srcset="img/placeholder.jpg" type="image/webp" />
                                <img class="lazy" data-src="img/placeholder.jpg" src="img/placeholder.jpg" alt="thumbnail" />
                            </picture>
                        </div>
            ...
            <div class="container">
                <div class="footer_main">
                        ...
                        <ul class="footer_main-block_nav">
                            <li class="list-item">
                                <a class="nav-link link" href="about.html" data-page="about">
                                    <i class="icon-chevron_right icon"></i> About us
                                </a>
                            </li>
                            <li class="list-item">
                                <a class="nav-link link" href="plant&machinery.html" data-page="services">
                                    <i class="icon-chevron_right icon"></i> Plant & Machinery 
                                </a>
                            </li>
                            <li class="list-item">
                            ...
                            <li class="list-item">
                                <a class="nav-link link" href="contact.html" data-page="contact">
                    ...
                    <div class="footer_main-block">
                        ...
                        <p class="footer_main-block_subtitle footer_main-block_subtitle--brand">
                            In the thriving city of Nashik, Forcon Infra is your one-stop shop for all your infrastructure requirements. We're here to assist fulfill the growing need for infrastructure as the city expands.
                        </p>
                    </div>
                    <div class="footer_main-block">
                        ...
                        <div class="group-wrapper">
                            ...
                            <div class="group">
                                <span>Bombay Address - 209, Maker Chamber-V,</span>
                        ...
                        <div class="group-wrapper">
                            <i class="icon-location icon"></i>
                            <div class="group">
                                <span>Nashik Address - 102. Hill View Apartment,  </span>
                                <span>Tidke Colony
                               Nashik, 422002</span>
                            </div>
                        </div><br>
                         <div class="group-wrapper">
                            ...
                            <div class="group">
                                <a href="tel:(0253) 2311657">(0253) 2311657</a>
                ...
                <div class="footer_secondary">
                    <p class="footer_secondary-copyright">
                        <span>Designed by Brand Theory</span>
                        <span>&copy; All rights reserved <span id="currentYear"></span></span>
                    </p>
                    <ul class="socials">
